export const PHRASE_TO_KEY: Record<string, string> = {
  ...
  "유니티 CI 닥터 템플릿": "preset.unityCiDoctor",
  "유니티 Testsmith 템플릿": "preset.unityTestsmith",
  "유니티 Build/Size Watcher 템플릿": "preset.unityBuildWatcher",
  "유니티 Localization QA 템플릿": "preset.unityLocalizationQa",
  "유니티 Addressables / Asset Diet 템플릿": "preset.unityAddressablesDiet",
